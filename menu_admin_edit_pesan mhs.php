...
mm_menu_0105104700_0.writeMenus();
} // mmLoadMenus()
...
<form name='login' action='../proyek/logut.php' method="get"></form>
<table id="Table_01" width="1025" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="4"><a href="proyek.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image58','','images/proyek_04coper.gif',1)"><img src="images/proyek_04.gif" name="Image58" width="168" height="36" border="0" id="Image58" /></a></td>
  ...
  <tr>
    ...
    <td colspan="6" rowspan="7" valign="top" background="images/proyek_15.gif"><div style="padding:3px;overflow:auto;width:auto;height:550px;border:1px solid grey" ><form><table border="1" cellpadding="5" cellspacing="0" align="center">
    <thead>
        <tr>
            <td>No.</td>
            <td>Nim</td>
    ...
    <tbody>
    <?php
    $query = mysql_query("select * from pesan_mhs p inner join data_mhs d on p.id_mhs=d.id_mhs");
    ...
    ?>
        <tr>
            ...
            <td><a href="edit_mhs.php?id=<?php echo $data['id_dosen']; ?>">Edit</a> || <a href="delete.php?id=<?php echo $data['id_mhs']; ?>">Hapus</a></td>
        </tr>
    <?php
        $no++;
    }
...
</table></form></div> <p align="center" class="style6">    
      <p align="center" class="style6"></td>
  ...
  <tr>
    ...
    <td colspan="2"><img src="images/kosong.gif" width="159" height="39" /></td>
  ...
  <tr>
    ...
    <td colspan="4"><img src="images/edit.gif" width="172" height="39" /></td>
