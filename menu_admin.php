...
<table id="Table_01" width="1025" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="4"><a href="menu_admin.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image58','','images/proyek_04coper.gif',1)"><img src="images/proyek_04.gif" name="Image58" width="168" height="36" border="0" id="Image58" /></a></td>
    <td rowspan="3"><a href="menu_admin.php"><img src="images/proyek_05.gif" alt="" name="proyek_05" width="3" height="85" border="0" id="proyek_05" /></a></td>
  ...
  <tr>
    ...
    <td colspan="6" rowspan="7" valign="top" background="images/proyek_15.gif"> <p align="center" class="style6">    
      <p align="center" class="style6"><a href="menu_admin_edit_data_mhs.php" target="_parent">Edit data mahasiswa </a><br />
        <a href="menu_admin_edit_data_dosen.php" target="_parent">Edit data dosen</a></p> 
      </td>
  ...
  <tr>
    ...
    <td colspan="4"><a href="menu_admin_pesan.php"><img src="images/edit.gif" width="172" height="39" border="0" /></a></td>
