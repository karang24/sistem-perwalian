...
<body bgcolor="#FFFFFF" onload="MM_preloadImages('images/proyek_06coper.gif','images/logit1.gif','images/proyek_08coper.gif','images/proyek_09coper.gif','../images/proyek_06coper.gif','../images/logit1.gif')">
...
<table id="Table_01" width="1025" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="4"><a href="menu_admin.php"><img src="images/proyek_04.gif" name="Image58" width="168" height="36" border="0" id="Image58" /></a></td>
  ...
  <tr>
    ...
    <td colspan="6" rowspan="7" valign="top" background="images/proyek_15.gif"><?php
$id=$_GET['id'];
$query = mysql_query("SELECT *from  data_mhs where id_mhs='$id' ") or die(mysql_error());
$data = mysql_fetch_array($query);
?>
<form name="update_data" action="update.php" method="post">
<input type="hidden" name="id" value="<?php echo $_POST['$id']?>" />
<table border="0" cellpadding="5" cellspacing="0" align="center" bgcolor="#3399FF">
    <tbody>
        <tr>
            <td>NPM</td>
            <td>:</td>
            <td><input type="text" name="npm" maxlength="100" required="required" value="<?php echo $data['npm']; ?>" /></td>
        </tr>
        <tr>
            <td>Nama</td>
            <td>:</td>
        ...
        <tr>
            <td>Keles</td>
            <td>:</td>
            <td><input type="text" name="kelas" required="required" value="<?php echo $data['id_kelas']; ?>" /></td>
        </tr>
...
</form><p align="center" class="style6">    
