...
<table id="Table_01" width="1025" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="6" rowspan="7" valign="top" background="images/proyek_15.gif"><form><table border="1" cellpadding="5" cellspacing="0" align="center">
    <thead>
        <tr>
            <td>No.</td>
            <td>Nim</td>
    ...
    <tbody>
    <?php
    $query = mysql_query("select * from pesan_dosen p right join data_dosen d on p.id_mhs=d.id_mhs");
...
</table></form> <p align="center" class="style6">    
