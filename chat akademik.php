...
<form name='login' action='../proyek/lougut.php' method="post">
<table id="Table_01" width="1025" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="6" rowspan="7" valign="top" background="images/proyek_15.gif">&nbsp;
		...
		<?php include "pesan_mhs.php";?>
        <textarea name="pesan" cols="70" rows="10" id="pesan" onfocus="CountMax();"
        onclick="CountMax();" onchange="CountMax();" onkeydown="CountMax();"
        onkeyup="CountMax();"  maxlength="500"></textarea>
		<input type="submit" name="TbSimpan" value="Kirim Pesan" />		</td>
  ...
  <tr>
    ...
    <td colspan="4"><img src="images/proyek_25.gif" alt="" name="image2" width="172" height="39" id="proyek_25" onmouseover="MM_showMenu(window.mm_menu_0104121425_0,169,36,null,'image2')" onmouseout="MM_startTimeout();" /></td>
