...
<table id="Table_01" width="1025" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="6" rowspan="7" valign="top" background="images/proyek_15.gif"><div style="padding:3px;overflow:auto;width:auto;height:550px;border:1px solid grey" ><form name='login' action='../proyek/logut.php' method="post"><table>
    <tbody><?php
    $query = mysql_query("select * FROM data_mhs dh inner join pesan_mhs pm on dh.id_mhs=pm.id_mhs");
    $no = 1;
    while ($data = mysql_fetch_array($query)) {
    ?>
      <textarea disabled="disabled" cols="70" rows="5"><?php echo $data['pesan']; ?></textarea><?php echo $data['npm']; ?> <?php echo $data['nama']; ?><?php echo $data['tanggal']; ?>
    <?php
        $no++;
    }
    ?>
