...
function mmLoadMenus() {
  if (window.mm_menu_0105173407_0) return;
        window.mm_menu_0105173407_0 = new Menu("root",138,46,"Times New Roman, Times, serif",16,"#CCCCCC","#FFFFFF","#0A2CFD","#0A2CFD","left","middle",15,0,1000,-5,7,true,false,true,0,true,true);
  mm_menu_0105173407_0.addMenuItem("Login&nbsp;Mahasiswa","window.open('login/tes-login-mhs.php', '_parent');");
  mm_menu_0105173407_0.addMenuItem("Login&nbsp;dosen","window.open('menu_mhs.php', '_parent');");
   mm_menu_0105173407_0.hideOnMouseOut=true;
   mm_menu_0105173407_0.bgColor='#555555';
   mm_menu_0105173407_0.menuBorder=1;
   mm_menu_0105173407_0.menuLiteBgColor='#FFFFFF';
   mm_menu_0105173407_0.menuBorderBgColor='#777777';

mm_menu_0105173407_0.writeMenus();
} // mmLoadMenus()
...
<body bgcolor="#FFFFFF" onload="MM_preloadImages('images/proyek_06coper.gif','images/proyek_04coper.gif','images/proyek_08coper.gif','images/proyek_09coper.gif','../images/proyek_06coper.gif')">
...
<table id="Table_01" width="1025" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="4"><a href="proyek.php"></a><a href="proyek.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image60','','images/proyek_04coper.gif',1)"><img src="images/proyek_04.gif" name="Image60" width="168" height="36" border="0" id="Image60" /></a><a href="proyek.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image60','','images/proyek_04coper.gif',1)"></a></td>
    <td rowspan="3"><img id="proyek_05" src="images/proyek_05.gif" width="3" height="85" alt="" /></td>
    <td rowspan="2"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image59','','images/proyek_06coper.gif',1)"></a><a href="../login/tes-login-mhs.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image62','','../images/proyek_06coper.gif',1)"></a><a href="login/tes-login-mhs.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image59','','images/proyek_06coper.gif',1)"><img src="images/proyek_06.gif" name="Image59" width="164" height="37" border="0" id="Image59" onmouseout="MM_startTimeout();" /></a></td>
    <td rowspan="3"><img id="proyek_07" src="images/proyek_07.gif" width="4" height="85" alt="" /></td>
    <td><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image58','','images/proyek_08coper.gif',1)"><img src="images/proyek_08.gif" name="Image58" width="167" height="36" border="0" id="Image58" /></a></td>
  ...
  <tr>
    ...
    <td colspan="6" rowspan="7" valign="top" background="images/proyek_15.gif">&nbsp;
        <div style="height: 500px; overflow: auto; width: 550px;">
          <p align="center" class="style3"><span class="style4">Selemat Datang Di Sistem Perwalian D4 Teknik Informatika</span> </p>
        </div></td>
