...
function mmLoadMenus() {
  if (window.mm_menu_1215213919_0) return;
          window.mm_menu_1215213919_0 = new Menu("root",102,40,"Arial, Helvetica, sans-serif",16,"#CCCCCC","#FFFFFF","#0A2CFD","#0A2CFD","left","middle",12,0,1000,-5,7,true,false,true,0,true,true);
  mm_menu_1215213919_0.addMenuItem("Tulis&nbsp;Pesan","window.open('chat akademik.php', '_parent');");
  mm_menu_1215213919_0.addMenuItem("Lhiat&nbsp;Pesan","window.open('tampil_mhs.php', '_parent');");
   ...
   mm_menu_1215213919_0.menuBorderBgColor='#777777';
    window.mm_menu_0105045812_0 = new Menu("root",101,22,"Arial, Helvetica, sans-serif",16,"#CCCCCC","#FFFFFF","#0A2CFD","#0A2CFD","left","middle",3,0,1000,-5,7,true,false,true,0,true,true);
  mm_menu_0105045812_0.addMenuItem("Lihat&nbsp;pesan");
  mm_menu_0105045812_0.addMenuItem("Tulis&nbsp;Pesan");
   mm_menu_0105045812_0.hideOnMouseOut=true;
   mm_menu_0105045812_0.bgColor='#555555';
   mm_menu_0105045812_0.menuBorder=1;
   mm_menu_0105045812_0.menuLiteBgColor='#FFFFFF';
   mm_menu_0105045812_0.menuBorderBgColor='#777777';

mm_menu_0105045812_0.writeMenus();
} // mmLoadMenus()
...
<form name='login' action='../proyek/logut.php' method="post">
<table id="Table_01" width="1025" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="4"><a href="proyek.html" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image58','','images/proyek_04coper.gif',1)"></a><a href="menu_mhs.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image59','','images/proyek_04coper.gif',1)"><img src="images/proyek_04.gif" name="Image59" width="168" height="36" border="0" id="Image59" /></a></td>
  ...
  <tr>
    ...
    <td colspan="6" rowspan="7" valign="top" background="images/proyek_15.gif"><div style="padding:3px;overflow:auto;width:auto;height:550px;border:1px solid grey" ><form><table>
    <tbody><?php
    $query = mysql_query("select * from pesan_dosen p inner join data_dosen d on p.id_pesan_dosen=d.id_pesan_dosen");
 
    $no = 1;
    while ($data = mysql_fetch_array($query)) {
    ?>
      <textarea disabled="disabled" cols="70" rows="5"><?php echo $data['pesan']; ?></textarea><?php echo $data['jam']; ?> <?php echo $data['tanggal']; ?>
    <?php
        $no++;
    }
    ?>
    </tbody></table></form></td></div>
  ...
  <tr>
    ...
    <td colspan="2"><img src="images/proyek_20.gif" alt="" name="image1" width="159" height="39" id="proyek_20" onmouseover="MM_showMenu(window.mm_menu_1215213919_0,159,0,null,'image1')" onmouseout="MM_startTimeout();" /></td>
  ...
  <tr>
    ...
    <td colspan="4"><img src="images/proyek_25.gif" alt="" name="image2" width="172" height="39" id="proyek_25" onmouseover="MM_showMenu(window.mm_menu_0105045812_0,169,36,null,'image2')" onmouseout="MM_startTimeout();" /></td>
